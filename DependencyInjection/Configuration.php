                    ...
                    ->children()
                        ->arrayNode('customer_type')
                            ...
                            ->children()
                                ...
                                ->scalarNode('entity')->cannotBeEmpty()->defaultValue('IMOControl\M3\CustomerBundle\Entity\BaseCustomerType')->end()
                    ...
                    ->children()
                        ->arrayNode('customer_address')
                            ...
                            ->children()
                                ...
                                ->scalarNode('entity')->cannotBeEmpty()->defaultValue('IMOControl\M3\CustomerBundle\Entity\BaseCustomerAddress')->end()
                                ->scalarNode('controller')->cannotBeEmpty()->defaultValue('IMOControlM3CustomerBundle:CRUD')->end()
                                ->scalarNode('translation')->cannotBeEmpty()->defaultValue('default')->end()
                            ->end()
                        ->end()
                    ...
                    ->children()
                        ->arrayNode('contact')
                            ...
                            ->children()
                                ...
                                ->scalarNode('entity')->cannotBeEmpty()->defaultValue('IMOControl\M3\CustomerBundle\Entity\BaseContact')->end()
                                ->scalarNode('controller')->cannotBeEmpty()->defaultValue('IMOControlM3CustomerBundle:CRUD')->end()
                                ->scalarNode('translation')->cannotBeEmpty()->defaultValue('default')->end()
                            ->end()
                        ->end()
                    ...
                    ->children()
                        ->arrayNode('customer_has_contacts')
                            ...
                            ->children()
                                ...
                                ->scalarNode('entity')->cannotBeEmpty()->defaultValue('IMOControl\M3\CustomerBundle\Entity\BaseCustomerHasContacts')->end()
                                ->scalarNode('controller')->cannotBeEmpty()->defaultValue('IMOControlM3CustomerBundle:CRUD')->end()
                                ->scalarNode('translation')->cannotBeEmpty()->defaultValue('default')->end()
                            ->end()
                        ->end()
